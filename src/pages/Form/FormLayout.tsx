    ...
    <>
      ...
      <div className=''>
        ...
        <div style={{ backgroundColor: 'rgba(0, 0, 0, 0.8)' }} id="modal" className="fixed z-40 top-0 right-0 left-0 bottom-0 h-full w-full hidden">
          <div className="p-1 max-w-xl mx-auto left-0 right-0 overflow-hidden mt-24">
            ...
            <div className="shadow w-full rounded-lg bg-white overflow-hidden block p-8">
              ...
              <div className="flex">
                <div className="mb-4 w-32 mr-1">
                  ...
                  <input className="text-right mb-1 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                    type="text"
                ...
                <div className="mb-4 w-32">
                  ...
                  <input className={`text-right mb-1 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-blue-500 ${getColor(ultimoPrecio, precioCosto)}`}
                    type="text"
              ...
              <div className="flex justify-end">
                <div className="mb-4 w-28 text-right">
                  ...
                  <div className="relative">
                    ...
                    <input className="text-right mb-1 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="number" defaultValue={1} onChange={(e) => setSelectedCantidad(e.target.value)} min={1} />
                  </div>

                  <div className="relative">
                    <label className="text-gray-800 block mb-1 font-bold text-sm uppercase tracking-wide ">Precio</label>
                    <input
                      className={`text-right mb-1 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-blue-500 ${color}`}
                      type="text"
                      value={precio}
