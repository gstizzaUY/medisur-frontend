...
const FormLayout = () => {
  const { clientes, setClientes, selectedCliente, setSelectedCliente, comprobantes, setComprobantes, selectedComprobante, setSelectedComprobante,
    selectedFechaFactura, setSelectedFechaFactura, items, setItems, selectedItem, setSelectedItem, precioCosto, setPrecioCosto,
    ultimoPrecio, setUltimoPrecio, selectedCantidad, setSelectedCantidad, precioVenta, setPrecioVenta, articulos, setArticulos, notas, setNotas,
    listaArticulos, setListaArticulos, movimiento, setMovimiento } = React.useContext(dataContext);
