    ...
    <aside
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/app">
          ...
          <h1 className="text-2xl font-bold text-white">Medisur APP</h1>
        </NavLink>
        ...
        >
          <BackspaceTwoToneIcon className="text-primary" />
        </button>
      </div>
      {/* <!-- SIDEBAR HEADER --> */}
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <DashboardCustomizeTwoToneIcon className="text-primary" />
                        Tablero
                        <svg
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ReceiptLongTwoToneIcon className="text-primary" />
                        Comprobantes
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'
                            }`}
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink onClick={() => setSidebarOpen(!sidebarOpen)}
                              to="/app/comprobantes/comprobantes-pendientes"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <Inventory2TwoToneIcon className="text-primary" />
                        Artículos
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'
                            }`}
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/app/tables' || pathname.includes('tables')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink onClick={() => setSidebarOpen(!sidebarOpen)}
                              to="/app/informes/compras-detalladas"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          <li>
                            <NavLink onClick={() => setSidebarOpen(!sidebarOpen)}
                              to="/app/informes/ventas-detalladas"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          <li>
                            <NavLink onClick={() => setSidebarOpen(!sidebarOpen)}
                              to="/app/informes/lista-clientes"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/app/cotizador' || pathname.includes('tables')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <CalculateTwoToneIcon className="text-primary" />
                        Cotizador
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'
                            }`}
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink onClick={() => setSidebarOpen(!sidebarOpen)}
                              to="/app/cotizador/nueva-cotizacion"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
